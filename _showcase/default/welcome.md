...
<div class="p-4">
    ...
    <hr />
    <p>
        <code>Showcase</code> is a page where you can show off almost anything you want. It can be the photo of your pets, your favorite books, your favorite publications, or anything else you want to show to the world.
    </p>
    <p>
